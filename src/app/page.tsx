  ...
  return (
    <main className="min-h-screen bg-zinc-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
            L’application de régime avec un vrai suivi humain.
          </h1>
          
          <p className="text-lg sm:text-xl text-zinc-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            Menus adaptés à votre quotidien, listes de courses et accompagnement par un coach diététique, selon vos goûts, votre budget et votre rythme de vie.
          </p>
          ...
          <p className="mt-4 text-sm text-white/80">Gratuit · Sans engagement · 3 minutes</p>
          
          <div className="flex flex-wrap justify-center gap-3">
            {[
              "Coach diététique humain",
              "Accompagnement humain inclus",
              "Adapté à votre budget",
              "Aucun aliment imposé"
            ].map((item) => (
              <span
                key={item}
      ...
      <section id="comment-ca-marche" className="py-24 sm:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 sm:mb-20">
            <Badge variant="secondary" className="mb-4 text-zinc-600">Comment ça se passe</Badge>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-zinc-900 tracking-tight">
              Un accompagnement diététique simple, structuré et efficace
            </h2>
          </div>
            ...
            {[
              {
                ...
                title: "Votre bilan alimentaire personnalisé",
                description: "Nous analysons vos habitudes, vos objectifs, votre budget et vos contraintes du quotidien."
              },
              {
                step: "02",
                icon: (
                ...
                title: "Un plan adapté à votre vraie vie",
                description: "Menus simples, listes de courses réalistes et conseils concrets, sans calculs compliqués."
              },
              {
                step: "03",
                icon: (
                ...
                title: "Un suivi humain avec un coach diététique",
                description: "Un professionnel vous accompagne, ajuste votre programme et répond à vos questions."
              }
            ].map((item, index) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-zinc-900 tracking-tight mb-4">
              Tout ce dont vous avez besoin pour réussir votre régime
            </h2>
            <p className="text-lg text-zinc-600 max-w-2xl mx-auto">
              JeRegime combine technologie et accompagnement humain pour perdre du poids durablement, sans vous priver.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            {[
              {
                image: "/jr/meals.jpg",
                title: "Menus adaptés à votre quotidien",
                description: "Des repas simples et personnalisés selon vos goûts, votre rythme et vos contraintes réelles."
              },
              {
                image: "/jr/groceries.jpg",
                title: "Listes de courses intelligentes",
                description: "Des courses claires et organisées, pensées pour votre budget et votre façon de consommer."
              },
              {
                image: "/jr/dietitian.jpg",
                title: "Accompagnement humain inclus",
                description: "Un diététicien vous accompagne en visio. De l’humain, pas un simple algorithme."
              }
            ].map((item, index) => (
      ...
      <section className="py-24 sm:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <p className="text-zinc-500">Des utilisateurs accompagnés par de vrais coachs diététiques, avec des retours concrets.</p>
          </div>
            ...
            {[
              {
                name: "Marie L.",
                avatar: "/jr/meals.jpg",
                text: "Pour la première fois, j’ai l’impression d’avoir un accompagnement qui s’adapte vraiment à mon quotidien.",
      ...
      <section className="py-24 sm:py-32 bg-zinc-50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-zinc-900 tracking-tight mb-4">
              Des résultats visibles, obtenus progressivement
            </h2>
            <p className="text-lg text-zinc-600 max-w-2xl mx-auto">
              Chaque parcours est unique. Les résultats varient selon votre situation et votre engagement.
            </p>
            
          </div>
          
          <h3 className="mb-6 text-center text-xl sm:text-2xl font-semibold text-zinc-900">
            Bougez le slider pour voir l’évolution
          </h3>
          <div className="relative rounded-3xl overflow-hidden shadow-xl">
            <BeforeAfterSlider beforeSrc="/jr/hero-before.jpg" afterSrc="/jr/hero-after.jpg" alt="Avant / Après" className="w-full" />
      ...
      <section className="py-24 sm:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12 sm:mb-16">
            <Badge variant="secondary" className="mb-4 text-zinc-600">FAQ</Badge>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-zinc-900 tracking-tight mb-4">
              Questions fréquentes
            </h2>
            <p className="text-lg text-zinc-600 max-w-2xl mx-auto">
              Tout ce que vous devez savoir avant de commencer votre bilan.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                q: "Le bilan personnalisé est-il gratuit ?",
                a: "Oui. Le bilan est gratuit et sans engagement. Il vous permet de faire le point sur votre alimentation et vos habitudes, avant toute décision.",
              },
              {
                q: "Que se passe-t-il après le bilan ?",
                a: "Vous recevez une analyse personnalisée et des premières recommandations adaptées à vos objectifs. Ensuite, si vous le souhaitez, vous pouvez échanger avec un coach diététique.",
              },
              {
                q: "Vais-je parler à un vrai coach ?",
                a: "Oui. Les échanges se font avec de vrais coach(s) diététique(s), en visio ou par téléphone. JeRegime n’est pas une simple application automatisée.",
              },
              {
                q: "Est-ce que je suis obligé(e) de prendre rendez-vous ?",
                a: "Non. Le bilan est sans engagement. Vous restez libre de décider de la suite.",
              },
              {
                q: "Combien de temps prend le bilan ?",
                a: "Environ 3 minutes. Des questions simples, sans calculs compliqués.",
              },
              {
                q: "Est-ce un suivi médical ?",
                a: "Non. JeRegime propose un accompagnement nutritionnel et comportemental, pas un suivi médical. En cas de pathologie, il est recommandé de consulter un professionnel de santé.",
              },
              {
                q: "À qui s’adresse JeRegime ?",
                a: "À toute personne qui souhaite perdre du poids durablement, mieux manger sans se priver, et être accompagnée par un humain — pas seulement une app.",
              },
            ].map((item) => (
              <details
                key={item.q}
      ...
      <section className="py-24 sm:py-32 bg-zinc-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight mb-6">
            Commencez par votre bilan personnalisé
          </h2>
          <p className="text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Faites le point sur votre alimentation et découvrez ce que vous pouvez améliorer, sans engagement.
          </p>
          ...
          <p className="mt-4 text-sm text-white/70">Gratuit · Sans engagement · 3 minutes</p>
